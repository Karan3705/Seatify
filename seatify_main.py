...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="karan@9904")
...
def login_pg():
    ...
    class login:
        ...
        def veri(self,primary_key):
         try:
          con = pymysql.connect(host="localhost", user="root", passwd="karan@9904", db="userdata")
          cursor = con.cursor()
  ...
  class signup:
    ...
    def connect_database(self):
        if self.txt_user.get() == '' or self.txt_email.get() == '' or self.txt_pass.get() == '':
            ...
            try:
                con = pymysql.connect(host="localhost", user="root", passwd="karan@9904")
                mycursor = con.cursor()
